...
# =============================================
# ✏️ 여기만 수정하세요
DOORAY_API_TOKEN = os.environ.get("DOORAY_API_TOKEN", "ajjt1imxmtj4:yEYzwAK_R9iid80SeSoJyw")
PROJECT_ID = "3880705043841564116"  # 포인트-주간보고
NOTIFY_WEBHOOK_URL = "https://nhnent.dooray.com/services/1916324552942047592/4306658334240562069/vvdT9Y-sRlmwOiClePZizg"
...
| 업무명 | 업무 구분 | 완료목표일 | 업무 대구분 | 소구분 | 일자 | 이번주 진행한 업무 현황 (자세히) | 업무 진행 두레이 링크 |
|--------|-----------|-----------|------------|--------|------|-------------------------------|------------------|
|        |           |           |            |        |      |                               |                  |
|        |           |           |            |        |      |                               |                  |
|        |           |           |            |        |      |                               |                  |
...
| 업무명 | 업무 구분 | 완료목표일 | 업무 대구분 | 소구분 | 담주에 진행할 업무 현황 (자세히) | 요청 또는 보고할 날짜 |
|--------|-----------|-----------|------------|--------|-------------------------------|------------------|
|        |           |           |            |        |                               |                  |
|        |           |           |            |        |                               |                  |
|        |           |           |            |        |                               |                  |
